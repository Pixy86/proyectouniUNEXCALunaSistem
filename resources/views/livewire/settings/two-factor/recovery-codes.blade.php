            ...
            <div class="mt-3 space-y-3">
                ...
                @if (filled($recoveryCodes))
                    ...
                    <flux:text variant="subtle" class="text-xs">
                        {{ __('Cada código de recuperación puede usarse una vez para acceder a tu cuenta y se eliminará después de su uso. Si necesitas más, haz clic en Regenerar códigos arriba.') }}
                    </flux:text>
                @endif
            </div>
        </div>
